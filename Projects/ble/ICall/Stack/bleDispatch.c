/**************************************************************************************************
  Filename:       bleDispatch.c
  Revised:        $Date: 2015-07-21 13:38:59 -0700 (Tue, 21 Jul 2015) $
  Revision:       $Revision: 44382 $

  Description:    ICall BLE Stack Dispatcher for embedded and NP/Serial messages.
...
#define GATT_MAX_NUM_RELIABLE_WRITES     5
  ...
  #define STACK_REVISION                 0x020100
                            ...
                            uint8 *pRspDataLen, uint8 *pSendCS)
{
  ...
  switch(opCode)
  {
    ...
    // TBD - Remove for next ROM spin. This is not a BLE command.
                              ...
                              uint8 *pRspDataLen, uint8 *pSendCS)
{
  ...
  switch(cmdID)
  {
    ...
    case HCI_EXT_UTIL_GET_TRNG:
      {
        uint32 trngVal = HalTRNG_GetTRNG();
                              ...
                              uint8 *pSendCS)
{
  ...
  switch(cmdID)
  {
    ...
    case ATT_READ_BY_GRP_TYPE_REQ: // GATT Discover All Primary Services
      stat = GATT_DiscAllPrimaryServices(connHandle, taskId);
      break;
  ...
  switch(cmdID)
  {
    ...
    case DISPATCH_GAP_BOND_SLAVE_REQ_SEC:
#if defined(GAP_BOND_MGR)
      {
        ...
        GAPBondMgr_SlaveReqSecurity(pReq->connHandle);
      }
#endif
      *pSendCS = FALSE;
      break;
