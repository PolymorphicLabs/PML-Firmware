/*******************************************************************************
  ...
  Description:    This file contains the PMLDot application's
...
#define LCD_WRITES_STATUS(s) PMLDot_displayStatus(s)
#else
...
/*
 * Task creation function for PMLDot
 */
extern void PMLDot_createTask(void);

/*
 * Function to call when a characteristic value has changed
 */
extern void PMLDot_charValueChangeCB(uint8_t sensorID, uint8_t paramID);

/*
 * Function to check the program stack
 */
extern void PMLDot_checkStack(void);

/*
 * Function to blink LEDs 'n' times
 */
extern void PMLDot_blinkLed(uint8_t led, uint8_t nBlinks);

/*
 * Function to load the factory image and reboot it
 */
extern void PMLDot_applyFactoryImage(void);
