 ...
 */
extern void PMLDotConnectionControl_init( void);

/*
 * Initialization for the  PMLDot
 */
extern void PMLDotConnectionControl_update( void);

/*
 * Task Event Processor for the BLE Application
 */
extern void PMLDotConnControl_processCharChangeEvt(uint8_t paramID);

/*
 * Connection parameters updated
 */
void PMLDotConnControl_paramUpdateCB( uint16_t connInterval, uint16_t
