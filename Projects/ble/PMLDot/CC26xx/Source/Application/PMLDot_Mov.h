...
/*
 * Initialization for the PMLDot movement task
 */
extern void PMLDotMov_init(void);

/*
 * Task Event Processor for PMLDot movement
 */
extern void PMLDotMov_processSensorEvent(void);

/*
 * Task Event Processor for characteristic changes
 */
extern void PMLDotMov_processCharChangeEvt(uint8_t paramID);

/*
 * Reset function for the Movement task
 */
extern void PMLDotMov_reset(void);

/*
 * Process MPU data ready interrupt
 */
extern void PMLDotMov_processInterrupt(void);
