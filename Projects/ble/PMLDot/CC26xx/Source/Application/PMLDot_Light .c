/*******************************************************************************
  Filename:       PMLDot_Light.c
  Revised:        $Date: 2013-11-20 20:28:12 +0100 (on, 20 nov 2013) $
  Revision:       $Revision: 36163 $

  Description:    This file contains the PMLDot LED Light application's
...
static void PMLDot_lightsReset(void); 
...
static void PMLDot_profileChangeCB(uint8 paramID);
static void PMLDot_processCharChangeEvt(uint8_t paramID);
static void PMLDot_setDeviceInfo(void);

#ifdef FEATURE_OAD
void PMLDot_processOadWriteCB(uint8_t event, uint16_t connHandle, 
                                           uint8_t *pData);
#endif //FEATURE_OAD
...
{
  PMLDot_profileChangeCB    // Characteristic value change callback
};
...
static void PMLDot_init(void)
{
  ...
  {
    PMLDot_blinkLed(Board_LED2,TEST_INDICATION_BLINKS);
  }
  else
  {
    PMLDot_blinkLed(Board_LED1,TEST_INDICATION_BLINKS);
  }
...
static void PMLDot_processCharValueChangeEvt(uint8_t serviceID, uint8_t paramID)
{
  ...
  case SERVICE_ID_LIGHT:
    PMLDot_processCharChangeEvt(paramID);
    break;
 ...
 * @return  none
 */
static void PMLDot_profileChangeCB(uint8_t paramID)
{
  // Wake up the application thread
  PMLDot_charValueChangeCB(SERVICE_ID_LIGHT, paramID);
}
...
/*********************************************************************
 * @fn      PMLDot_processCharChangeEvt
 *
