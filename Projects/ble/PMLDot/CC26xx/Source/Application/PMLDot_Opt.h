...
/*
 * Initialization for the PMLDot light sensor
 */
extern void PMLDotOpt_init( void);

/*
 * Task Event Processor for characteristic changes
 */
extern void PMLDotOpt_processCharChangeEvt(uint8_t paramID);

/*
 * Task Event Processor for Sensor reading
 */
extern void PMLDotOpt_processSensorEvent( void);

/*
 * Task Event Processor for the BLE Application
 */
extern void PMLDotOpt_reset( void);
