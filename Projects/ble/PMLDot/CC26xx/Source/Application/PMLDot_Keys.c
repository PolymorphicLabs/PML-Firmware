...
/*********************************************************************
 * @fn      PMLDotKeys_processKeyRight
 *
 * @brief   Interrupt handler for BUTTON 1(right)
 *
 */
void PMLDotKeys_processKeyRight(void)
{
...
/*********************************************************************
 * @fn      PMLDotKeys_processKeyLeft
 *
 * @brief   Interrupt handler for BUTTON 2 (left)
 *
 */
//void PMLDotKeys_processKeyLeft(void)
//{
...
/*********************************************************************
 * @fn      PMLDotKeys_processRelay
 *
 * @brief   Interrupt service routine for reed relay
 *
 */
//void PMLDotKeys_processRelay(void)
//{
...
/*********************************************************************
 * @fn      PMLDotKeys_processEvent
 *
 * @brief   PMLDot Keys event processor.  
 *
 */
void PMLDotKeys_processEvent(void)
{
  ...
  if (current_keys != keys)
  {
        ...
        && (keys & SK_PUSH_KEYS)!=SK_PUSH_KEYS )
    {
      ...
      {
//        PMLDot_blinkLed(Board_BUZZER, 10);
        
        // Apply factory image and reboot
        PMLDot_applyFactoryImage();
      }
    }
  }
