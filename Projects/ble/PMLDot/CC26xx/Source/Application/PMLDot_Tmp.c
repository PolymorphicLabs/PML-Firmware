 ...
 * @return  none
 */
void PMLDotTmp_createTask(void)
{
 ...
 * @fn      sensorTaskInit
 *
 * @brief   Initialization function for the PMLDot IR temperature sensor
 *
 */
...
static void sensorConfigChangeCB(uint8_t paramID)
{
  ...
  PMLDot_charValueChangeCB(SERVICE_ID_TMP, paramID);
}
