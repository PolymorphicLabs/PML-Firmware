...
/*********************************************************************
 * @fn      PMLDotDisplay_init
 *
 * @brief   Initialization function for the PMLDot Display
 *
 */
void PMLDotDisplay_init(void)
{
...
/*********************************************************************
 * @fn      PMLDotDisplay_processCharChangeEvt
 *
 * @brief   Process a change in the IO characteristics
 *
 * @return  none
 */
void PMLDotDisplay_processCharChangeEvt(uint8_t paramID)
{
  if (paramID == DISPLAY_CONF)
  {
    ...
    case DISPLAY_CONF_INV:
      devpkLcdInvert();
      PMLDot_displayStatus("Connected");
      break;
 ...
 * @return  none
 */
void PMLDot_displayStatus(const char *strStatus)
{
  uint8_t buf[24];
...
/*******************************************************************************
 * @fn      PMLDot_displayBatteryVoltage
 *
 ...
 * @return  none
 */
void PMLDot_displayBatteryVoltage(void)
{
  char buf[24];
  uint32_t batt;
...
static void displayChangeCB( uint8_t newParamID )
{
  ...
  PMLDot_charValueChangeCB(SERVICE_ID_DISPLAY, newParamID);
}
