 ...
 */
extern void PMLDotIO_init( void);

/*
 * Task Event Processor for IO service
 */
extern void PMLDotIO_processCharChangeEvt( uint8_t paramID );

/*
 * Reset the IO service
 */
extern void PMLDotIO_reset( void);

/*
 * Get the IO mode (local or remote)
 */
extern uint8_t PMLDotIO_getMode( void);
