 ...
 * @return  none
 */
void PMLDotBar_createTask(void)
{
...
/*********************************************************************
 * @fn      PMLDotBar_processCharChangeEvt
 *
 * @brief   PMLDot Barometer event handling
 *
 */
void PMLDotBar_processCharChangeEvt(uint8_t paramID)
{
  uint8_t newValue;
 ...
 * @fn      sensorTaskInit
 *
 * @brief   Initialization function for the PMLDot barometer
 *
 */
...
//      if (success)
//      {
//        sensorMs5607Convert(data,&temp,&press);
//
//        data[2] = (temp >> 16) & 0xFF;
//        data[1] = (temp >> 8) & 0xFF;
//        data[0] = temp & 0xFF;
...
static void sensorConfigChangeCB(uint8_t paramID)
{
  ...
  PMLDot_charValueChangeCB(SERVICE_ID_BAR, paramID);
}
