...
/*******************************************************************************
 * @fn      PMLDotConnectionControl_init
 *
 * @brief   Initialization function for the PMLDot keys
 *
 */
void PMLDotConnectionControl_init(void)
{
  // Add service
...
/*******************************************************************************
 * @fn      PMLDotConnectionControl_update
 *
 * @brief   Update the Connection Control service with the current connection
 *          control settings
 *
 */
void PMLDotConnectionControl_update(void)
{
...
/*******************************************************************************
 * @fn      PMLDotConnControl_processCharChangeEvt
 *
 * @brief   Process a change in the connection control characteristics
 *
 * @return  none
 */
void PMLDotConnControl_processCharChangeEvt(uint8_t paramID)
{
...
/*******************************************************************************
 * @fn      PMLDotConnControl_paramUpdateCB
 *
 ...
 * @return  none
*/
void PMLDotConnControl_paramUpdateCB(uint16_t connInterval, 
...
static void ccChangeCB(uint8_t paramID)
{
  ...
  PMLDot_charValueChangeCB(SERVICE_ID_CC, paramID);
}
