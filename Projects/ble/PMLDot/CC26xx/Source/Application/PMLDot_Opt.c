...
static void initCharacteristicValue(uint8_t paramID, uint8_t value, 
                                    uint8_t paramLen);
static void PMLDotOpt_clockHandler(UArg arg);
...
void PMLDotOpt_init(void)
{
  ...
  Util_constructClock(&periodicClock, PMLDotOpt_clockHandler,
                      100, sensorPeriod, false, 0);
}

/*********************************************************************
 * @fn      PMLDotOpt_processCharChangeEvt
 *
 * @brief   PMLDot Accelerometer event handling 
 *
 * @param   paramID - parameter identifier
 *
 */
void PMLDotOpt_processCharChangeEvt(uint8_t paramID)
{
  uint8_t newValue;
...
/*********************************************************************
 * @fn      PMLDotOpt_processSensorEvent
 *
 * @brief   PMLDot Light Meter event processor.  
 *
 */
void PMLDotOpt_processSensorEvent(void)
{
...
static void sensorConfigChangeCB(uint8_t paramID)
{
  ...
  PMLDot_charValueChangeCB(SERVICE_ID_OPT, paramID);
}
