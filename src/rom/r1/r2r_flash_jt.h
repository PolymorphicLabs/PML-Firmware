/******************************************************************************
 ...
 @brief This file contains the defines for every LL and HCI function which can
        be mapped to either itself (for Flash-Only build), or to jump table
...
#define MAP_LL_DirectTestRxTest                          ((uint8           (*) (uint8))                                                                                        R2R_JT_OFFSET(101))
#define MAP_LL_DirectTestTxTest                          ((uint8           (*) (uint8, uint8, uint8))                                                                          R2R_JT_OFFSET(102))
...
#define MAP_LL_EXT_ConnEventNotice                       ((uint8           (*) (uint8, uint16))                                                                                R2R_JT_OFFSET(122))
...
// Mapped functions which were not part of the original ROM image and thus are
// always directly mapped to their flash counterpart
