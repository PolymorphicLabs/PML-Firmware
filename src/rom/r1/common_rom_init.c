...
#endif //defined( ENABLE_ROM_CHECKSUM_CHECK )


extern void ROM_Spinlock( void );
...
#define RT_Init_CommonROM ((RT_CommonInit_fp)&COMMON_ROM_BASE_ADDR)
...
typedef void (*RT_CommonInit_fp)(void);
...
const uint32 R2R_Flash_JT_CommonROM[] =
{
  ...
  (uint32)ROM_Spinlock,                                  // PLACE HOLDER
  #define MB_Init
  #define MB_EnableInts
  #define MB_DisableInts
  #define MB_ClearInts
  #define MB_EnableHWInts
  #define MB_ReadMailboxStatus
  #define MB_SendCommand
  #define MB_SendCommandSynch
  #define MB_RegisterIsrCback
  #define MB_FwDebugDump
  #define mbCpe0Isr
  #define mbCpe0Isr
  #define mbCpe1Isr
  #define mbHwIsr
