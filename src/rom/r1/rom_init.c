...
const uint32 R2F_Flash_JT[] =
{
  ...
  (uint32)ROM_Spinlock,                                  // PLACE HOLDER
  #define LL_PM_Init
  #define LL_PM_StartRfTask
  #define LL_PM_PowerOnReq
  #define LL_PM_PowerCycleRadio
  #define LL_PM_ForceSysBusThroughRF
  #define LL_PM_PowerOnRfCore
  #define LL_PM_StopCurTaskTimer
  ...
  (uint32)ECC_initialize,                                // R2F_JT_OFFSET[39]
  (uint32)ECC_generateKey,                               // R2F_JT_OFFSET[40]
  //(uint32)ECC_ECDSA_sign,                              // R2F_JT_OFFSET[41]
  (uint32)ECC_ECDH_computeSharedSecret,                  // R2F_JT_OFFSET[41]
#else // !SECURE_CONNS_CFG
  (uint32)ROM_Spinlock,                                  // PLACE HOLDER
  (uint32)ROM_Spinlock,                                  // PLACE HOLDER
  //(uint32)ROM_Spinlock,                                // PLACE HOLDER
  (uint32)ROM_Spinlock,                                  // PLACE HOLDER
  #define ECC_initialize
  #define ECC_generateKey
  //#define ECC_ECDSA_sign
  #define ECC_ECDH_computeSharedSecret
...
(uint32)LL_EXT_DelaySleep,                               // R2R_JT_OFFSET(125)
  ...
  // ROM WORKAROUND: THIS CALL IS DEFUNCT
