...
#define LL_FEATURE_RESERVED01                          0x08
#define LL_FEATURE_RESERVED02                          0x10
#define LL_FEATURE_RESERVED03                          0x20
#define LL_FEATURE_RESERVED04                          0x40
#define LL_FEATURE_RESERVED05                          0x80
// Byte 2 - Byte 7
...
// ROM WORKAROUND
// Scanner Event Extension Parameters
typedef struct
{
  uint8       paramValid;                            // flag to indicate paraetmers are valid
...
#define LL_TEST_MODE_TP_SEC_MAS_BV_04                33
#define LL_TEST_MODE_TP_SEC_MAS_BI_09                34
// V5.0 - 2Mbps
...
#if defined(CTRL_V41_CONFIG) && (CTRL_V41_CONFIG & MST_SLV_CFG)
extern advInfoExt_t  advInfoExt;                      // advertiser data extended
#endif // CTRL_V41_CONFIG & MST_SLV_CFG
extern scanInfo_t    scanInfo;                        // scan data
extern scanInfoExt_t scanInfoExt;                     // scan data extended
...
// TEMP: ONLY TO GET THE ROM BUILD WORKING
