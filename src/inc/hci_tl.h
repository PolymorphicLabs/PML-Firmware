/******************************************************************************
 ...
 @brief This file contains the types, constants, external functions etc. for
...
#define HCI_EXT_SCAN_EVENT_NOTICE                         0xFC22 // Not a supported HCI command! Application only.
...
#define HCI_EXT_SCAN_EVENT_NOTICE_EVENT                   0x0422 // Not a supported HCI command! Application only.
